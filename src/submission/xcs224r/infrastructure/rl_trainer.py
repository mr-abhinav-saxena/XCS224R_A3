...
class RL_Trainer(object):
    ...
    def __init__(self, params: Dict[str, Any]) -> None:
        ...
        # Note: Pointmass envs don't support render_mode
        is_pointmass = 'pointmass' in self.params['env_name'].lower()
        needs_video = (self.params['video_log_freq'] > 0) or ('env_wrappers' in self.params) or ('non_atari_colab_env' in self.params)
